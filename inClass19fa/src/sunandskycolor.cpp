...
sunAndSkyColor::sunAndSkyColor(float cycleSpeed):
      ...
      sunSetColor(sunRiseColor),
      moonMidNightColor(glm::vec3(100.f, 100.f, 100.f) * (1.f / 255.f)),
      // Unique sky color at sun rise, noon, and sun set
      //skyRiseColor(glm::vec3(102.f, 192.f, 229.f) * (1.f/ 255.f)),
      skyRiseColor(glm::vec3(66.f, 22.f, 12.f) * (1.f/ 255.f)),
      skyNoonColor(glm::vec3(255.f, 255.f, 255.f) * (1.f / 255.f)),
      skySetColor(skyRiseColor),
      skyMidNightColor(glm::vec3(20.f, 24.f, 82.f) * (1.f / 255.f))
      //skyMidNightColor(glm::vec3(255.f, 255.f, 255.f) * (1.f / 255.f))
